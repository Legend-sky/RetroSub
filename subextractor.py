...
class SubMolExtractor():
    ...
    def __init__(self,
        ...
        Args:
            ...
            max_fp_radius (int, optional): the maximum radius of Morgan fingerprints. Defaults to 6.    Morgan指纹的最大半径。
            min_count (int, optional): the min count common fingerprints. Defaults to 5.                常见指纹的最小计数。
            min_fp_radius (int, optional): the min radius of Morgan fingerprints. Defaults to 2.        Morgan指纹的最小半径。
        """
